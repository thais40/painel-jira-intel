    ...
    for projeto in PROJETOS:
        ...
        while True:
            ...
            params = {
                ...
                "startAt": start_at,
                "maxResults": 100,
                "fields": "summary,created,resolutiondate,status"
            }
...
with abas[0]:
    ...
    fig = go.Figure()
    fig.add_bar(x=grafico['mes_str'], y=grafico['Criados'], name='Criados', marker_color='green')
    fig.add_bar(x=grafico['mes_str'], y=grafico['Resolvidos'], name='Resolvidos', marker_color='blue')
